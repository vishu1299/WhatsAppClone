    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: Row(
          ...
          children: [
            new CircleAvatar(
              foregroundColor: new Color(0xff075E54),
            ...
            new Column(
              children: <Widget>[
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(top: 3.0, right: 50.0, left: 15.0),
                  child: new Text(
                    "Online",
                    style: new TextStyle(
                  ...
                  new Flexible(
                      ...
                      child: new Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            new Text(
                              "Hi,\nThis is the last Oppurtunity for you to be a part of the biggest fest.",
